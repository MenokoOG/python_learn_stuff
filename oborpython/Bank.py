"""Creating an object manager for bank project, creating a bank class, Menoko OG 4-20-2013, National MaraJuana Day!!!!"""
#Bank tha manages a dictionary of Account objects
from Account import *
